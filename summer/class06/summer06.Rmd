---
title: "QTM 150"
subtitle: "ggplot2 and dplyr <html><div style='float:left'></div><hr color='#f2a900' size=1px width=800px></html>"
...
* ggplo2: numeric and categorical graphs
...
We will have a **quiz** posted today. Due by **Wednesday**.

I will add the grades for the first homework today. Make sure that you completed the DataCamp assignment.

I will assign tomorrow two chapters of the DataCamp course related to the dplyr. They are due next Tuesday.

Final project: the instructions will be on today. I will assign you to groups, and you will have to record a video.

The Final Project is due next Friday, one week after the course ends.
